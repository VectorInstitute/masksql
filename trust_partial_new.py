"""Run the MaskSQL pipeline for text-to-SQL generation with privacy masking."""
...
class FixFormat(JsonListTransformer):
    """Transformer that fixes the format by copying SQL to query field."""
...
def create_pipeline_stages(conf: MaskSqlConfig):
    ...
    Args:
        conf: MaskSQL configuration object containing paths and model settings.
