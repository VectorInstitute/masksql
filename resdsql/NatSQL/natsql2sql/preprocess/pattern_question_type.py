...
PATTERNS = [
    ...
    + " | + V * PCOL"
    + " | + V PCOL | + that PCOL | + who PCOL | + and PCOL | + and * PCOL | + PCOL | + * PCOL | and TABLE with PCOL"
    ...
    + " | + V * TABLE PCOL"
    + " | + V TABLE PCOL | + that TABLE PCOL | + who TABLE PCOL | + and TABLE PCOL | + and * TABLE PCOL | + TABLE PCOL | + * TABLE PCOL"
    ...
    + " | + V * _TABLE_ TCOL"
    + " | + V _TABLE_ TCOL | + that _TABLE_ TCOL | + who _TABLE_ TCOL | + and _TABLE_ TCOL | + and * _TABLE_ TCOL | + _TABLE_ TCOL | + * _TABLE_ TCOL"
